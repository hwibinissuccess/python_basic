...
'''
  ...
  3. 객체 생성
'''
from inspect import  *  # 모듈 객체를 검사할 때 사용하는 모듈 : 동적으로 생성된 클래스와 멤버 정보를 확인
class Person:
    __b = 10
...
class Student(Person):
    def __init__(self,name, age,b, grade = 5 ):
       # Person.__init__(self,name,age)  #첫줄에 기재
...
if __name__ == '__main__':
    ...
    print("5. 멤버 확인  :", getmembers(Student, predicate=isfunction))
    print("6. 소스확인 :" , getsource(Student))
    print("7. doc 확인 :", getdoc(Student))
